...
public class StaxBuilderTest {
    ...
    StaxBuilder plantsBuilder;

    @BeforeTest
    public void init() {
        plantsBuilder =new StaxBuilder();
    }
    ...
    @Test (expectedExceptions = PlantException.class, expectedExceptionsMessageRegExp = ".*Error in Stax:.*")
    public void testBuildSetGemsException() throws PlantException {
        String xmlPath="resources/flowersNone.xml";
        plantsBuilder.buildSetPlants(xmlPath);
    }
}
